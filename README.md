...
The goal of this project was to better understand the fundamentals of computer graphics, rendering pipelines, and mathematical concepts used in 3D environments. The project focuses on simulating how rays interact with objects and light sources to generate rendered scenes.
